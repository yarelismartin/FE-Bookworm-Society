            ...
            {!hasVoted && (
              <div className="mt-auto">
                <div className="flex justify-center">
                  <button type="button" onClick={() => handleVote(book.id)} className="flex items-center justify-center w-12 h-12 rounded-full bg-gray-200 hover:bg-gray-300 transition duration-300 mt-2">
