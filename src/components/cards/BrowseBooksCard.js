...
export default function BrowseBooksCard({ bookObj }) {
  return (
    <div className="line-break">
      <div className="book-wrapper card bg-transparent border-none pb-4 w-32 sm:w-44 md:w-40 lg:w-48 xl:[width:10rem] group">
        {/* Aspect ratio for consistent height */}
        <div className="relative aspect-[2/3]  overflow-hidden transition-transform duration-300 ease-in-out group-hover:scale-105">
